...
Route::middleware('auth:web,api')->group(function () {
    ...
    Route::post('visits/{visit}/services-revenue-invoice', [VisitController::class, 'storeServicesRevenueInvoice'])->name('visits.services-revenue-invoice');
    ...
    Route::get('invoices/{invoice}/items/{item}/treatment-eligibility-print', [VisitController::class, 'treatmentEligibilityPrintForItem'])->name('invoices.items.treatment-eligibility-print');
    ...
    Route::get('invoices/{invoice}/charity-email-preview', [InvoiceController::class, 'previewCharityEmail'])->name('invoices.charity-email-preview');
