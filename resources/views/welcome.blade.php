<!DOCTYPE html>
<html lang="{{ app()->getLocale() === 'ar' ? 'ar-SA-u-nu-latn' : str_replace('_', '-', app()->getLocale()) }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600&family=cairo:400,500,600,700"
        rel="stylesheet" />
...
<body
    ...
    <footer class="mt-auto py-8 text-center text-slate-500 text-sm font-medium">
        <div class="mb-1">
            &copy; {{ date('Y') }} <span class="text-slate-900 font-bold">Abeer Suleiman</span>.
