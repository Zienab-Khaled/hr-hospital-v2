            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('patients.search') }}"
                        class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-600 text-white font-semibold hover:bg-slate-700 text-sm shadow-sm transition-colors border-2 border-slate-600">
