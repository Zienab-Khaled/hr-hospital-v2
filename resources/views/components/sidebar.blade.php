    ...
    <nav class="px-3 py-3">
        ...
        @if ($user->can('patients.view') || $isManager)
            <div class="mt-3 mb-1">
                ...
                <a href="{{ route('patients.section.charity') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('patients.section.charity') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('patients.section.cash') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('patients.section.cash') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('patients.section.insurance') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('patients.section.insurance') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('patients.section.followup') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('patients.section.followup') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('patients.section.collection') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('patients.section.collection') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($user->can('invoices.view') || $isManager)
            <a href="{{ route('invoices.index') }}"
                class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
               {{ request()->routeIs('invoices.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
        ...
        @if ($user->can('authorizations.view') || $isManager)
            <a href="{{ route('authorizations.index') }}"
                class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
               {{ request()->routeIs('authorizations.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($user->can('payments.view') || $user->can('payments.approve') || $isManager)
            <a href="{{ route('payments.index') }}"
                class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
               {{ request()->routeIs('payments.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($user->can('claims.view') || $isManager)
            <a href="{{ route('claims.index') }}"
                class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
               {{ request()->routeIs('claims.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($isManager)
            <div class="mt-3 mb-1">
                ...
                <a href="{{ route('departments.index') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('departments.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('services.index') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('services.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('insurance-companies.index') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('insurance-companies.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                ...
                <a href="{{ route('charity-entities.index') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('charity-entities.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                    </svg>
                ...
                <a href="{{ route('users.index') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('users.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
                    <span>{{ __('Users') }}</span>
                ...
                <a href="{{ route('settings.index') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('settings.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('codes.upload') }}"
                    class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
                   {{ request()->routeIs('codes.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                    <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($user->can('reports.view') || $isManager)
            <a href="{{ route('reports.index') }}"
                class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
               {{ request()->routeIs('reports.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if ($user->can('activity.view'))
            <a href="{{ route('activity.index') }}"
                class="flex items-center gap-2.5 px-3 py-1.5 mb-0.5 rounded-md text-sm font-normal transition-colors
               {{ request()->routeIs('activity.*') ? 'bg-red-600 ' : 'text-slate-700 hover:bg-red-600 hover:' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
