@extends('layouts.app')
@section('title', app()->getLocale() === 'ar' ? 'إضافة محضر عدم تعهد' : 'Add Non-Commitment Report')
@section('content')
    <h2 class="text-xl font-semibold text-slate-800 mb-6">{{ app()->getLocale() === 'ar' ? 'إضافة محضر عدم تعهد' : 'Add Non-Commitment Report' }}</h2>
