            ...
            <div class="mb-6">
                @if ($approval->status === 'approved')
                    ...
                    <p class="text-lg text-slate-600">
                        The approval request <strong>{{ $approval->approval_number }}</strong> has been successfully
                        approved.
                    </p>
                @else
            ...
            <div class="bg-slate-50 rounded-lg p-6 mb-6">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="font-bold {{ $approval->status === 'approved' ? 'text-green-600' : 'text-red-600' }}">
                    ...
                    @if ($approval->status === 'approved')
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold text-green-600">{{ number_format($approval->approved_amount, 2) }}
                                SAR</span>
                        </div>
                    @endif
                    <div class="flex justify-between">
