...
/**
 * يزرع موظفي الإيرادات حسب الهيكل الإداري:
 * - الاستقبال (الطوارئ، العيادات): 9 محصلين
 * - التأمين: متابعة مطالبات (2) + فني متابعة مرضى (2)
 * - المحاسب (2)، أمين الصندوق (1)، رئيس المديونيات (1)
 * القيادات (مدير النظام، مسؤولة الجمعيات، رئيس قسم التأمين) في ProductionUsersSeeder.
 */
